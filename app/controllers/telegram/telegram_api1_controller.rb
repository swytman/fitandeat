class Telegram::TelegramApi1Controller < ApplicationController

  def details
    respond_to do |format|
      format.json do
        return(head :bad_request) unless params[:program_id]
        ...
        unless program
          ...
          response = render_to_string(:template => 'telegram/programs/details',
                                      :layout => false,
